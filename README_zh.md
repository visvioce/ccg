...
本项目的作者不会写代码。真的。一行 Go 代码都不是手写出来的。整个代码库都是通过与 AI 对话生成的——只需要描述需求，让 AI 来完成工作。

**这有什么意义？**
- 如果一个不会编程的人都能做出这个，想象一下你能做什么
- AI 辅助开发是未来的趋势
- 不需要 Go 语言知识就能定制或扩展
- 只需要描述你想要什么，AI 就能帮你修改

**WSL 的问题**
原版 CCR（Node.js 版本）因为内存问题经常导致 WSL 崩溃。与其花几周时间学习 Go 编程，不如直接让 AI 用 Go 重写。结果？内存使用量减少 80%，几小时就得到了可用的解决方案，而不是几周。

**你也可以试试！**
想添加功能？直接问 AI。代码库对 AI 友好，结构清晰，适合进一步的 AI 辅助开发。
